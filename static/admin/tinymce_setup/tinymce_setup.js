tinyMCE.init({
    ...
    theme_advanced_buttons1: ',bold,italic,underline,|,bullist,numlist,blockquote,|,link,unlink,|,pasteword,charmap,|,code,|search,|,table,cleanup,grappelli_documentstructure|,fullscreen,',
